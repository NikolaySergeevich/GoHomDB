...
const (
	...
	LinkService_GetLink_FullMethodName         = "/pb.LinkService/GetLink"
	LinkService_GetLinkByUserID_FullMethodName = "/pb.LinkService/GetLinkByUserID"
	LinkService_UpdateLink_FullMethodName      = "/pb.LinkService/UpdateLink"
	LinkService_DeleteLink_FullMethodName      = "/pb.LinkService/DeleteLink"
...
func (c *linkServiceClient) GetLinkByUserID(ctx context.Context, in *GetLinksByUserId, opts ...grpc.CallOption) (*ListLinkResponse, error) {
	...
	err := c.cc.Invoke(ctx, LinkService_GetLinkByUserID_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *linkServiceClient) ListLinks(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ListLinkResponse, error) {
	out := new(ListLinkResponse)
	err := c.cc.Invoke(ctx, LinkService_ListLinks_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LinkService_GetLinkByUserID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LinkService_GetLinkByUserID_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
