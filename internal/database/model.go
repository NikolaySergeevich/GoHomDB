...
func (l *Link) LinkString() string{
	var res string
	var timeCreate string
	var timeUpdate string
	timeCreate = timeCreate + l.CreatedAt.Format("02.01.2006 15 часов 04 минут 05 сек.")
	timeUpdate = timeUpdate + l.UpdatedAt.Format("02.01.2006 15 часов 04 минут 05 сек.")
	res = res + "link's information:\n" + "  Title: " + l.Title + "\n  URL: " + l.URL + "\n  CreateAT: " + timeCreate + "\n  UpdateAT" + timeUpdate + "\n"
	return res
}
